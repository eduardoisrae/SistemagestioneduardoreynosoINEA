...
<body>
    <div class="container">
        ...
        <%
            // Recuperar el ID del equipo a eliminar
            ...
            try {
                // Preparar la consulta SQL para eliminar el equipo
                ...
                if (filasAfectadas > 0) {
                    out.println("<div class='alert success'>Equipo eliminado correctamente.</div>");
                } else {
                    out.println("<div class='alert error'>Error al eliminar el equipo.</div>");
                }
